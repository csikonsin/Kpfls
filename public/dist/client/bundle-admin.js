...
var renderHydrate = _reactDom.render;
if (_helpers2.default.USE_SSR) {
    renderHydrate = _reactDom.hydrate;
}
renderHydrate(_react2.default.createElement(_App2.default, { store: preloadedState }), document.getElementById("app"));
